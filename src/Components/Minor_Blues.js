...
import g_minor from '../Components/assets/tunes/G_minor.wav';
...
const Minor_Blues = () => {
    ...
    const [currentNoteIndices, setCurrentNoteIndices] = useState(Array(7).fill(0));
    const notes = ['A', 'A#', 'Bb', 'B', 'C', 'C#', 'Db', 'D', 'D#', 'Eb', 'E', 'F', 'F#', 'Gb', 'G', 'G#', 'Ab'];
    const [answer, setAnswer] = useState(Array(7).fill('A')); // Initialize answer array with A alphabet

    const number_array = [6, 1, 2, 'b3', 3, 5, 6];
    ...
    return (
        ...
        <div className="homePage-bg_major_pentatonic">
            ...
            <div className='s1_cont_minor_blues'>
                <h3 className='heading' >Minor Blues Scales</h3>
                <div className='cont0'>
