...
const Minor_scales = () => {
    ...
    const correct_answer = {
        ...
        7: ['D', 'E', 'F', 'G', 'A', 'Bb', 'C', 'D'],
        8: ['G', 'A', 'Bb', 'C', 'D', 'Eb', 'F', 'G'],
        9: ['C', 'D', 'Eb', 'F', 'G', 'Ab', 'Bb', 'C'],
        10: ['F', 'G', 'Ab', 'Bb', 'C', 'Db', 'Eb', 'F'],
        11: ['Bb', 'C', 'Db', 'Eb', 'F', 'Gb', 'Ab', 'Bb'],
    }

    return (

        <div className="homePage-bg_minor_scales">

            {/* navbar code */}
            <div className="mainContainer_navbar_minor_scales" >
                <div className='cont0_navbar_minor_scales'>
                    ...
                    <div className='cont2_navbar'>
                        <a href="#" className='nav_btns_minor_scales' >
                    ...
                    <div className='cont3_navbar'>
                        {/* <a href="#" className='nav_btns_minor_scales' >Logout</a> */}
            ...
            <div className='s1_cont_minor_scales'>
                <h3 className='heading' >Minor Scales</h3>
                <div className='cont0'>
