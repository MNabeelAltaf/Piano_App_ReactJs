...
const Major_Blues = () => {
    ...
    const number_array = [1, 2, 'b3', 3, 5, 6, 1];
    ...
    const correct_answer = {
        ...
        8: ['Bb', 'C', 'Db', 'D', 'F', 'G', 'Bb'],
        9: ['Eb', 'F', 'Gb', 'G', 'Bb', 'C', 'Eb'],
        10: ['Ab', 'Bb', 'B', 'C', 'Eb', 'F', 'Ab'],
        11: ['Db', 'Eb', 'E', 'F', 'Ab', 'Bb', 'Db'],
    }
    ...
    return (
        ...
        <div className="homePage-bg_major_pentatonic">
            ...
            <div className='s1_cont_major_blues'>
                <h3 className='heading' >Major Blues Scales</h3>
                <div className='cont0'>
